...
testApp.directive("customValidationEdit", function(){
  return {
    ...
    '        Valid:'+
    '        <input type="checkbox" ng-disabled="disabled"  ng-model="validation_data.valid" ng-disabled="not_editable_list.indexOf(\'Validation\')!=-1">'+
    '      </div>'+
    '      <div class="control-group" ng-show="validation_data.valid">'+
    '        nEvents:'+
    '        <input type="number" ng-disabled="disabled"  ng-model="validation_data.nEvents" ng-disabled="not_editable_list.indexOf(\'Validation\')!=-1">'+
    '      </div>'+
...
testApp.directive("customAnalysisId", function(){
  return {
    ...
    '       <input ng-model="new_id" ng-disabled="not_editable_list.indexOf(\'Analysis id\')!=-1">'+
